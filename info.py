...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003320166866'))  # Premium logs channel id
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Aswanthcreator') # Owner link for the bot
